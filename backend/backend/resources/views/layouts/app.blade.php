...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="{{asset('assets/img/logo.png')}}" />
    <!-- Fonts -->
...
.sidebar {
    ...
    border-right: 1px solid #e5e7eb;
    box-shadow: 2px 0 10px rgba(0, 0, 0, 0.05);
    overflow: hidden; /* Parent ko overflow hidden */
}
...
/* IMPORTANT: SIDEBAR CONTENT SCROLL FIX */
.sidebar-nav-container {
    flex: 1;
    min-height: 0; /* Flex child ko scroll allow karega */
    display: flex;
    flex-direction: column;
    overflow: hidden;
}
...
/* Chrome, Safari, Opera */
.sidebars-contents::-webkit-scrollbar {
    display: none;
}
...
.sidebars-contents::-webkit-scrollbar-thumb:hover {
    background: #a8a8a8;
}
   ...
   @yield('scripts')
    ...
    <script>
        $('.btn-delete').click(function(e){
            e.preventDefault(); // <- YE LINE MUST HAI

            let form = $(this).closest('form'); // closest form ko target karo
