    ...
    <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6 mb-3 mb-md-0">
            <div class="d-flex align-items-center justify-content-center justify-content-md-start">
                ...
                <h4 class="mb-0 text-white">Privacy & Policies Management</h4>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="policyTable" class="table table-hover table-striped">
                    <thead>
                        <tr>
                            <th width="50">#</th>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group" style="gap: 6px;">
                                    ...
                                    <form id="delete-form-{{ $item->id }}"
                                          action="{{ route('deletePolicy', $item->id) }}"
...
<div class="modal fade" id="addPolicyModal" tabindex="-1" aria-labelledby="addPolicyModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <form action="{{ route('storePolicy') }}" method="POST">
          @csrf
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form id="editPolicyForm" method="POST">
                ...
                @method('PUT')
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="editPolicyModalLabel">Edit Privacy & Policy</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
        ...
        buttons: [
            {
                ...
                title: 'Privacy_Policies_Export_' + new Date().toISOString().slice(0,10)
            },
            {
                extend: 'pdfHtml5',
...
function openEditModal(id, title, description) {
    let url = '{{ route("updatePolicy", ":id") }}';
    url = url.replace(':id', id);
    $('#editPolicyForm').attr('action', url);
